...
const gameWordPendu = () => {
  ...
  let wordRandomArray = [];
  wordRandomArray = words[indexWord];
  ...
  selectWord =>    V,O,I,T,U,R,E

  displayLetter => _,O,_,_,_,R,_

  avant map [_,O,_,_,_,R,_]
  après map [V,O,_,_,_,R,_]
